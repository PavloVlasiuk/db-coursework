...
-- AddForeignKey
ALTER TABLE `feedbacks` ADD CONSTRAINT `feedbacks_media_request_id_fkey` FOREIGN KEY (`media_request_id`) REFERENCES `media_requests`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
